...
class ZHZBaseViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        initUI()
        //判断是否登录 登录再加载数据
        ZHZNetworkManager.shared.userLogon ? loadData() :()
        //注册登录成功通知
...
// MARK: - 访客视图监听方法
extension ZHZBaseViewController {
...
extension ZHZBaseViewController{
    ...
    fileprivate func initUI(){
        ...
        steupNavigationBar()
        ZHZNetworkManager.shared.userLogon ? steupTableView() : steupVisitorView()
    }
...
// MARK: - 代理方法
extension ZHZBaseViewController:UITableViewDelegate,UITableViewDataSource {
